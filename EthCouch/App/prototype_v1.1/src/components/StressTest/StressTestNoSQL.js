...
class StressTestNoSQL extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div>
                Stress Test NoSQL
                <Button onClick={() => this.getDataEntries(this.state.parent.state.amount)}>Start Stress-Test NoSQL</Button>
                {this.state.time}
            </div>
        );
    }
...
export default StressTestNoSQL;