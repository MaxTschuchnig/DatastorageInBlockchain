...
class EthComponent extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            contract_address: "0x7280a9b047088e51fa6038e8ffedd042ddf6be93",
    ...
    getEntriesFromTo() {
        ...
        xhr.onreadystatechange = () => {
            if (xhr.readyState === 4 && xhr.status === 200) {
                // Get Json from Response Text
                let json = JSON.parse(xhr.responseText);
                this.parseEntriesJsonFromTo(json, this.state.from, this.state.to);
            }
        };
            ...
            <div>
                <div>
                    ...
                    <Center>
                        ...
                        <Input name="from" type="number" value={this.state.from} onChange={this.handleChange} className="mm" placeholder='from...' />
                        <Input name="to" type="number" value={this.state.to} onChange={this.handleChange} className="mm" placeholder='to...' />
                        <Button onClick={() => this.getEntriesFromTo()} className="mm">Get Data w Bounds</Button>
