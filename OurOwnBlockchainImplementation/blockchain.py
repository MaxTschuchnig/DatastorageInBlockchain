...
def make_transaction(payer, receiver, amount):
    # u before to create unicode
    pay = -1 * int(amount)
    get = -1 * pay

    return  {u''.join(receiver):get,u''.join(payer):pay}

# Creates a valid transaction in range of 1 - Max Value-
def make_random_transaction(maxValue = 3):
...
# Test Functions - to test functionality and generate state
'''
